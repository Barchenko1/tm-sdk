...
public class RelationshipEntityManagerDaoTest extends AbstractDaoTest {
    ...
    void getEntityWithDependencies_success() {
        ...
        Employee result = entityDao.getGraphEntity(GRAPH_PATH, parameter);
    ...
    void getEntityListGraph_success() {
        ...
        List<Employee> result = entityDao.getGraphEntityList(GRAPH_PATH, parameter);
    ...
    void getNamedQueryEntityList_success() {
        ...
        List<Employee> result = entityDao.getNamedQueryEntityList(NAMED_QUERY_NAME_ONE, parameter);
    ...
    void classTypeChecker_withMatchingTypes_shouldNotThrowException() {
        Item item = new Item();
        RelationshipEntityManagerDaoTest.ItemDaoExposed singleEntityDao = new RelationshipEntityManagerDaoTest.ItemDaoExposed();
    ...
    void classTypeChecker_withNonMatchingTypes_shouldThrowException() {
        Object object = new Object();
        RelationshipEntityManagerDaoTest.ItemDaoExposed singleEntityDao
                = new RelationshipEntityManagerDaoTest.ItemDaoExposed();
