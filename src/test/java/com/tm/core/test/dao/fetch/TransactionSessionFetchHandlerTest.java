...
public class TransactionSessionFetchHandlerTest extends AbstractDaoTest {
    ...
    void getGraph_Entity_success() {
        ...
        Employee result = transactionTemplate.execute(status ->
                fetchHandler.getGraphEntity(Employee.class, GRAPH_PATH, parameter));
        checkEmployee(expectedEmployee, result);
    }
    ...
    void getNamedQuery_Entity_success() {
        ...
        Employee result = transactionTemplate.execute(status ->
                fetchHandler.getNamedQueryEntity(Employee.class, NAMED_QUERY_NAME_ONE, parameter));
        checkEmployee(expectedEmployee, result);
    }
