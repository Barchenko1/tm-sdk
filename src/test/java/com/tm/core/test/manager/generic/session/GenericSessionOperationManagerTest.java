package com.tm.core.test.manager.generic.session;
...
import com.tm.core.process.manager.generic.impl.AbstractGenericOperationManager;
import com.tm.core.process.manager.generic.impl.GenericOperationManager;
...
class GenericSessionOperationManagerTest extends AbstractDaoTest {
    ...
    void saveRelationshipEntity_transactionFailure() {
        ...
        try {
            Field daoField = AbstractGenericSessionFactoryDao.class.getDeclaredField("sessionFactory");
            daoField.setAccessible(true);
            daoField.set(genericDao, sessionFactory);
    ...
    void getEntityWithDependencies_success() {
        ...
        Employee result = transactionTemplate.execute(status ->
                genericOperationManager.getGraphEntity(Employee.class, GRAPH_PATH, parameter));
    ...
    void getEntityListGraph_success() {
        ...
        List<Employee> result = transactionTemplate.execute(status ->
                genericOperationManager.getGraphEntityList(Employee.class, GRAPH_PATH, parameter));
